...
class CreativeMonitorSeed
{
    public static function state(): array
    {
        ...
        return [
            ...
            'equipment' => [
                self::equipment('e-1', 'Cinema Camera A', 'Camera', 'CAM-A913', 'Excellent', 'In Use', 'Ari Lim', $date(7), $date(30), '2022-08-10', '2028-08-10'),
                self::equipment('e-2', 'Prime Lens 50mm', 'Lens', 'LEN-5030', 'Good', 'In Use', 'Dina Rahman', $date(4), $date(60), '2021-03-09', '2027-03-09'),
                self::equipment('e-3', 'Podcast Room', 'Studio Room', 'ROOM-POD', 'Good', 'Booked', 'Amir Hassan', $date(2), $date(88), '2020-01-01', '2030-01-01'),
                self::equipment('e-4', 'LED Lighting Set', 'Lighting', 'LGT-410', 'Excellent', 'Available', '', '', $date(90), '2024-02-04', '2029-02-04'),
            ],
            'assets' => [
            ...
            'team' => [
                self::person('u-1', 'Maya Noor', 'Creative Lead', 'Management', 'Admin', 88, ['Approval', 'Resource planning', 'Video review']),
                self::person('u-2', 'Sofia Chan', 'Design Manager', 'Graphic Design', 'Manager', 76, ['Design systems', 'Client proofing']),
                self::person('u-3', 'Ari Lim', 'Video Editor', 'Video Production', 'Member', 92, ['Editing', 'Color', 'Motion']),
                self::person('u-4', 'Dina Rahman', 'Photographer', 'Photography', 'Member', 68, ['Product shoots', 'Retouching']),
                self::person('u-5', 'Ken Wong', 'Audio Producer', 'Podcast Production', 'Member', 54, ['Mixing', 'Voice cleanup']),
            ],
            'announcements' => [
            ...
            'audit' => [
                ...
                ['id' => 'log-2', 'actor' => 'Ari Lim', 'action' => 'File upload', 'detail' => 'Uploaded Hero_RoughCut_v2.mov', 'date' => $date(-3)],
            ],
            'workflowWeightage' => [
